...
- Condition serialization with SBCL serialization like CLOS serialization and other implementations producing a =json= object with =condition= and =report= keys.
